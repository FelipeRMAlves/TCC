...
class matriz3D():  
    def __init__(self, X, Y, Z, v1, v2, v3, v4):
        ...
        self.b1 = (Y[v2] - Y[v4])*(Z[v3] - Z[v4]) - (Y[v3] - Y[v4])*(Z[v2] - Z[v4])
        self.b2 = (Y[v3] - Y[v4])*(Z[v1] - Z[v4]) - (Y[v1] - Y[v4])*(Z[v3] - Z[v4])
        self.b3 = (Y[v1] - Y[v4])*(Z[v2] - Z[v4]) - (Y[v2] - Y[v4])*(Z[v1] - Z[v4])
        self.b4 = -(self.b1 + self.b2 + self.b3)

        self.c1 = (X[v3] - X[v4])*(Z[v2] - Z[v4]) - (X[v2] - X[v4])*(Z[v3] - Z[v4])
        self.c2 = (X[v1] - X[v4])*(Z[v3] - Z[v4]) - (X[v3] - X[v4])*(Z[v1] - Z[v4])
        self.c3 = (X[v2] - X[v4])*(Z[v1] - Z[v4]) - (X[v1] - X[v4])*(Z[v2] - Z[v4])
        self.c4 = -(self.c1 + self.c2 + self.c3)

        self.d1 = (X[v2] - X[v4])*(Y[v3] - Y[v4]) - (X[v3] - X[v4])*(Y[v2] - Y[v4])
        self.d2 = (X[v3] - X[v4])*(Y[v1] - Y[v4]) - (X[v1] - X[v4])*(Y[v3] - Y[v4])
        self.d3 = (X[v1] - X[v4])*(Y[v2] - Y[v4]) - (X[v2] - X[v4])*(Y[v1] - Y[v4])
    ...
    def matrizk(self, k):
        ...
        B = (1.0/(6.0*self.vol))*np.array([[self.b1, self.b2, self.b3, self.b4],
